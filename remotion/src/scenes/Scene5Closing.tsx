...
export const Scene5Closing = () => {
  ...
  const titleY = interpolate(
    spring({ frame: frame - 25, fps, config: { damping: 18 } }),
    [0, 1], [50, 0]
  );
  ...
  const particles = Array.from({ length: 12 }, (_, i) => {
    ...
    const distance = interpolate(frame, [0, 40], [0, 300 + (i % 3) * 100], { extrapolateRight: "clamp" });
  ...
  return (
    <AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
      ...
      <div style={{
        ...
        textShadow: `0 0 ${40 * pulse}px rgba(0,212,255,0.4)`,
        letterSpacing: 3,
      }}>
        NEXUS AI HUB
      </div>
      ...
      {/* Gradient bar */}
      <div style={{
        width: interpolate(frame, [70, 110], [0, 500], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }),
        height: 4,
